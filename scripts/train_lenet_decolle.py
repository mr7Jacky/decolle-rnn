...
# Licence : GPLv2
#-----------------------------------------------------------------------------
from decolle.lenet_decolle_model import LenetDECOLLERNN, LenetDECOLLE, DECOLLELoss, LIFLayerVariableTau, LIFLayer
...
args = parse_args('parameters/params_nmnist_test.yml')
device = args.device
args.no_save = True
...
if net.__class__.__name__ == 'LenetDECOLLE':
    ...
    from decolle.init_functions import init_LSUV_RNN
    init_LSUV_RNN(net, data_batch[:32])
##Resume if necessary
